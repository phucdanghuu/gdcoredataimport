...
Pod::Spec.new do |s|
  ...
  s.description  = "Wrapper to import data into CoreData using MagicalRecord"
  ...
  s.source       = { :git => "https://github.com/phucdanghuu/gdcoredataimport.git", :branch => "v0.6.7" ,:tag => "#{s.version}" }
